...
export default React.memo(FileImage);
...
const SelectFile = React.memo(function SelectFile() {
  ...
  const { setValue } = processParamsForm;
  ...
  const onclickNext = useCallback(() => {
    ...
    // Force use OCR/VLM parse by setting customPdfParse to true
    setValue('customPdfParse', true);
    goToNext();
  }, [goToNext, setValue]);
