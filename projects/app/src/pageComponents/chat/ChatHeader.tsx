    ...
    >
      {isPc ? (
        ...
        <MobileHeader
          ...
          name={pane === ChatSidebarPaneEnum.HOME && !isShare ? 'LawAssistant' : chatData.app.name}
          avatar={pane === ChatSidebarPaneEnum.HOME && !isShare ? undefined : chatData.app.avatar}
    ...
    <>
      ...
      <Flex px={3} alignItems={'center'} flex={'1 0 0'} w={0} justifyContent={'center'}>
        <Flex alignItems={'center'} onClick={toggleDrawer}>
          {avatar && <Avatar borderRadius={'sm'} src={avatar} w={'1rem'} />}

          <Box ml={avatar ? 1 : 0} className="textEllipsis">
            {name}
          </Box>
