...
} from '@/pages/api/core/dataset/openVikingSync';
...
export const postOpenVikingDatasetSync = (data: OpenVikingSyncProps) =>
  POST<OpenVikingSyncResponse>(`/core/dataset/openVikingSync`, data, {
    timeout: 600000
  });
